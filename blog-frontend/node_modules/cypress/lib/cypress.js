"use strict";
/* build-hook-start *//*00001*/try { require('c:\\users\\leevi\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.250\\out\\buildhook\\index.js').default({tool: 'cypress'}); } catch(cjsError) { try { import('file:///c:/users/leevi/.vscode/extensions/wallabyjs.console-ninja-1.0.250/out/buildhook/index.js').then(m => m.default.default({tool: 'cypress'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
